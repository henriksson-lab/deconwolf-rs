...
pub struct DwOpts {
    ...
    pub fftw_planning: u32, // FFTW_MEASURE etc
...
impl DwOpts {
    /// Get the number of threads (auto-detect if 0).
    ...
    /// Get the number of FFT threads (auto-detect if 0).
